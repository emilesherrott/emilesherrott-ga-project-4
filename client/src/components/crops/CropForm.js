      ...
      {formData &&
        <div className="">
          ...
          <form onSubmit={handleSubmit} className="cropform-form">
            ...
            <div className="d-flex justify-content-between cropform-input">
              <div className="form-group" onClick={backItUp}>
                <h3 type="submit" className="cropform-back-button">Back it up</h3>
              </div>
              <div className="form-group">
                <button type="submit" className="cropform-button">{buttonText}</button>
              </div>
            </div>
          </form>
        </div>}
