...
const Nav = () => {
  ...
  return (
    <div className="container nav-container">
      <nav className="navbar navbar-expand-lg navbar-light bg-light home-text nav-container">
        <div className="container-fluid nav-container">
          <Link className="navbar-brand nav-container" to="/">Back To Yard</Link>
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><Link className="dropdown-item" to="/whoami">Who Am I?</Link></li>
